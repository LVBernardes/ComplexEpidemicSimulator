...
from complex_epidemics.agents.support_objects.disease.disease_instance_builder import DiseaseInstanceBuilder
from complex_epidemics.agents.support_objects.disease.disease_recipes import DiseaseRecipe
...
class DiseaseFactory:
    @staticmethod
    def covid_19_standard(model: SimulationModel, initial_infected: float):
